...
import { Eye, ArrowUpRight, ArrowDownRight, EyeOff } from "lucide-react";
...
interface TradeTableProps {
  ...
  onToggleHidden?: (trade: Trade, hidden: boolean) => void;
  isLoading?: boolean;
}

export function TradeTable({ trades, onViewTrade, onToggleHidden, isLoading }: TradeTableProps) {
                  ...
                  <div className="flex gap-1">
                    ...
                    {onToggleHidden && (
                      <Button
                        ...
                        onClick={(e) => {
                          e.stopPropagation();
                          onToggleHidden(trade, !trade.hidden);
                        }}
                        data-testid={`button-toggle-hidden-${trade.id}`}
                      >
                        {trade.hidden ? (
                          <Eye className="h-4 w-4" />
                        ) : (
